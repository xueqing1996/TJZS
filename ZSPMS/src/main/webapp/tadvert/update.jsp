			...
			<tbody id="tab_1">
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="title" maxlength="100" size="100" value="${advert.title }" onblur="chktitle()"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<textarea name="content" rows="30" cols="100"  onblur="chkcontent()">${advert.content }</textarea>
