...
<div style="margin-top:15px;">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="list.do?page=${PAGE+1>PAGECOUNT?PAGECOUNT:PAGE+1}&loginname=${QUERY.loginname}
	&isenabled=${QUERY.isenabled}">下一页</a>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="list.do?page=${PAGECOUNT}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">
	最后页</a>
	
	&nbsp;&nbsp;&nbsp;&nbsp;当前第${PAGE}页 /共${PAGECOUNT}页</div>
